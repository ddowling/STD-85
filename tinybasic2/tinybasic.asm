;Modified Jan 1 2023 by Denis Dowling for use with STD-85 computer
;Removed DWA macro
;INIT, CHKIO, OUTC
;Changed all ORG statements for 8K of RAM at C000H
;
...
OC3:    IN   UARTA_CTRL                 ;Check status
        ANI  1H                         ;STATUS BIT
        JZ   OC3                        ;NOT READY, WAIT
        POP  PSW                        ;READY, GET OLD A BACK
        OUT  UARTA_DATA                 ;Out to data port
        CPI  CR                         ;WAS IT CR?
        RNZ                             ;NO, FINISHED
...
LSTROM:                                 ;ALL ABOVE CAN BE ROM
        ...
        ORG  0C000H                     ;STD-85 8K RAM START
...
TXTBGN: DS   2                          ;TEXT SAVE AREA BEGINS
        ORG  0DF00H                     ;Set for STD-85 8K SRAM
...
STKLMT: DS   1                          ;TOP LIMIT FOR STACK
        ORG  0E000H                     ;STD-85 8K RAM C000-DFFF
